        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                <div class="flex flex-col gap-4">
                    ...
                    <p class="font-PoiretOne">Bvlgari Man Rain Essence Парфюмерная вода 100 мл</p>
                    <p class="text-2xl">10 868₽</p>
                </div>
                <div class="flex flex-col gap-4">
                    <a href="Pages/product.html"
                        class="relative group overflow-hidden rounded-xl border border-black/10 shadow-[0px_0px_13px_-7px_black]">
                    ...
                    <p class="text-base opacity-50">Парфюмерная вода</p>
                    <p class="font-PoiretOne">Art&nose Composition #2 Парфюмерная вода 90 мл</p>
                    <p class="text-2xl">1 595 ₽</p>
                </div>
                <div class="flex flex-col gap-4">
                    <a href="Pages/product.html"
                        class="relative group overflow-hidden rounded-xl border border-black/10 shadow-[0px_0px_13px_-7px_black]">
                        <img src="{{ asset('Images/products/3.png') }}" alt=""
                            class="transition-all duration-500 group-hover:scale-110 w-full">
                    </a>
                    <p class="text-base opacity-50">Парфюмерная вода</p>
                    <p class="font-PoiretOne">Palazzo Della Bellezza Dono Divino Парфюмерная вода 100 мл</p>
                    <p class="text-2xl">2 690 ₽</p>
                </div>
                <div class="flex flex-col gap-4">
                    <a href="Pages/product.html"
                        class="relative group overflow-hidden rounded-xl border border-black/10 shadow-[0px_0px_13px_-7px_black]">
                        <img src="{{ asset('Images/products/5.png') }}" alt=""
                            class="transition-all duration-500 group-hover:scale-110 w-full">
                    </a>
                    <p class="text-base opacity-50">Парфюмерная вода</p>
                    <p class="font-PoiretOne">Korloff Парфюмерная вода lady korloff in white edp 50мл</p>
                    <p class="text-2xl">4 800 ₽</p>
                </div>
            </div>
        </div>
